...
**Keywords.** Neural Networks; Extension of Exposures; 
...
The `keras` package offers a great way to quickly fit neural nets for research. Refer to the `keras` package for more detail and everything you need to know about modeling with `keras`. The [Keras site](https://keras.rstudio.com/) is a great place to start. 
...
Fitting the model is simple. The model is trained for 300 epochs.
